// Vercel API route for contacts (GET all contacts, POST new contact, DELETE specific contact)
...
export default async function handler(req, res) {
  ...
  try {
    ...
    if (req.method === 'POST') {
      ...
      const result = await createDataInFirebaseTransactional('contacts', formData);
