    ...
    <footer className="bg-gray-900 text-white">
      ...
      <div className="container mx-auto px-4 pt-16 pb-8">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
          {/* Company Info */}
          <div>
            <img src={logo} alt="Company Logo" className="h-16 w-auto mb-4" width="160" height="64" />
            ...
            <div className="flex flex-col md:flex-row items-center">
              ...
              <p className="text-sm text-gray-500 mt-1 md:mt-0 flex items-center gap-1">
                ...
                <a
                  ...
                  target="_blank"
                  rel="noopener noreferrer"
                  className="text-primary hover:text-orange-500 transition-colors font-medium"
                >
                  Godiva Tech
                </a>
              </p>
