        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-12 items-center">
          <div>
            ...
            <p className="text-gray-600 mb-4">
              OM Vinayaga Associates is an authorized franchise of Building
              Doctor, bringing professional building repair and maintenance
              solutions to Madurai and surrounding areas.
            </p>
            <p className="text-gray-600 mb-6">
              With a strong foundation in technical expertise and customer
              service, we have established ourselves as the go-to specialists
              for waterproofing, structural repairs, and construction chemicals
              in the region.
            </p>
            ...
            <div className="space-y-4 mb-8 ">
              <div className="flex items-start">
                ...
                <div>
                  ...
                  <p className="text-gray-600">
                    To provide high-quality, affordable building repair
                    solutions that enhance the longevity and value of our
              ...
              <div className="flex items-start">
                ...
                <div>
                  ...
                  <p className="text-gray-600">
                    We combine technical expertise with personalized service,
                    ensuring each project receives the attention to detail it
                    deserves.
                  </p>
                </div>
              </div>
            ...
            <div className="flex flex-col sm:flex-row gap-4">
              <Link
                to="/contact"
                className="bg-primary hover:bg-primary/90 text-white px-6 py-3 rounded-md font-medium transition text-center"
              >
                Contact Us
              </Link>
              <Link
                to="/services"
                className="bg-white hover:bg-gray-100 text-primary px-6 py-3 rounded-md font-medium transition border border-primary text-center"
              >
                Our Services
              </Link>
            </div>
              ...
              <div className="col-span-1 md:col-span-2">
                <div className="bg-white shadow-xl rounded-xl overflow-hidden h-full p-8">
                  ...
                  <p className="text-gray-600 mb-6">
                    ...
                    are experts in their respective domains. Our team includes:
                  </p>
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                    ...
                    <div className="flex items-start">
                      ...
                      <div>
                        ...
                        <p className="text-gray-600 text-sm">
                          Skilled professionals trained in the correct
                          application of our specialized products.
                        </p>
                      </div>
                    </div>
                    ...
                    <div className="flex items-start">
                      ...
                      <div>
                        ...
                        <p className="text-gray-600 text-sm">
                          Dedicated professionals ensuring timely completion and
                    ...
                    <div className="flex items-start">
                      ...
                      <div>
                        ...
                        <p className="text-gray-600 text-sm">
                          Responsive team providing ongoing support and guidance
                          for all your building maintenance needs.
                        </p>
                      </div>
                    </div>
                  </div>
                  ...
                  <div className="mt-6 pt-6 border-t border-gray-100">
                    <p className="text-gray-600 text-sm">
                      Together, we bring a combined experience of over 50 years
                      in the building repair and maintenance industry, dedicated
