...
export const PRODUCTS = [
  ...
  // Waterproofing Category
  {
    ...
    price: 680,
    image:
      "/uploads/images/BD-DAMPSTOP-XW-20LIT.png",
    rating: 4.7,
    isBestseller: false,
    category: "waterproofing",
    packageSizes: [
      { size: "5 kg", price: 680 },
      { size: "20 Lit", price: 2875 }
    ],
    ...
    fullDescription: "BD DAMP STOP XW is a rising damp proofing solution specially designed for wet walls. Low viscosity, highly penetrating silane solution that permanently stops rising dampness in masonry walls. இவை சுவர்களில் ஏற்படக்கூடிய RISING DAMPNESS - யை தடுக்கக்கூடிய பிரத்யேக பொருளாகும், ஈரமான சுவர்களில் பயன்படுத்தலாம்.",
    hasVideo: true,
    videoId: "rUNM-IWmhxA",
    autoPlayVideo: true
  },
