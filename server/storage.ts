...
export interface IStorage {
  ...
  createGalleryItem(item: Omit<GalleryItem, 'id' | 'createdAt'>): Promise<GalleryItem>;
...
export const storage: IStorage = {
  ...
  // Gallery methods
  getGalleryItems: () => firebaseStorage.getGalleryItems(),
  getGalleryItem: (id) => firebaseStorage.getGalleryItem(id),
  createGalleryItem: (item) => firebaseStorage.createGalleryItem(item),
  deleteGalleryItem: (id) => firebaseStorage.deleteGalleryItem(id),
